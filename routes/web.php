...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::post('district','PageController@district');
    Route::post('wards','PageController@wards');
    Route::post('findwards','PageController@findwards');
    ...
    Route::get('tra-cuu-bao-hanh.html','PageController@tracuubaohanh')->name('tracuubaohanh');
    Route::get('dang-ky-bao-hanh.html','PageController@dangkybaohanh')->name('dangkybaohanh');
    Route::get('tiep-nhan-bao-hanh.html','PageController@tiepnhanbaohanh')->name('tiepnhanbaohanh');
    Route::get('dang-ky-dai-ly.html','PageController@dangkydaily')->name('dangkydaily');
    Route::post('dang-ky-dai-ly.html','PageController@postdangkydaily')->name('postdangkydaily');
    ...
    Route::get('he-thong-dai-ly.html','PageController@daiLy')->name('daiLy');
