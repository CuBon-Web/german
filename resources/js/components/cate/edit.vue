            ...
            <div class="card-body">
              ...
              <form class="forms-sample">
                ...
                <div class="form-group">
                  ...
                  <ImageMulti v-model="objData.imagehome" :title="'san-pham-cate-'"/> 
                </div>
                <div class="form-group">
                  <label>Vị trí hiển thị slide tại trang chủ</label>
                  <vs-select v-model="objData.location_banner">
                    <vs-select-item value="1" text="Bên Trái" />
                    <vs-select-item value="0" text="Bên Phải" />
                  </vs-select>
                </div>
                <div class="form-group">
                  <label>Ảnh trang list</label>
                  <image-upload
...
export default {
  ...
  methods: {
    ...
    saveEdit() {
      ...
      if(this.objData.order_id == 0) this.errors.push('Nhập vị trí sắp xếp');
    ...
    getInfoCates(){
      ...
      this.getInfoCate(this.objData).then(response => {
        ...
        if(response.data == null){
          ...
          this.objData.imagehome = JSON.parse(response.data.imagehome);
        }
      }).catch(error => {
        console.log(12);
      });
