      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="text-center" style="margin-bottom: 5px; margin-top: -3px">
            <h3 class="text-white">
              Chào mừng bạn đến với trang quản trị do German sáng lập
            </h3>
            <p class="text-lead text-white">
              Toàn bộ thông tin của website của bạn đều được chúng tôi bảo mật tuyệt đối. Trang quản trị này chỉ dành riêng cho bạn. Nếu bạn quên tài khoản đăng nhập, vui lòng liên hệ với German để được cấp lại tài khoản
            </p>
          </div>
        </div>
      </div>
