...
<section class="bread-crumb">
 ...
 <div class="blog_wrapper layout-blog mt-3" itemscope itemtype="https://schema.org/Blog">
    <meta itemprop="name" content="Tra cứu bảo hành">
     <div class="container">
       <div class="row">
          <div class="right-content col-lg-12 col-12">
             ...
             <div class="row list-news">
                        ...
                        <div class="aside-content aside-content-blog">
                           ...
                           <nav class="nav-category">
                                <ul class="nav navbar-pills">
                                    ...
                                    <li class="nav-item  relative">
                                        <a title="Tin tức" class="nav-link active" href="{{route('tracuubaohanh')}}">Tra cứu bảo hành</a>
                                    </li>
                                    <li class="nav-item  relative">
                ...
                <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12">
                    <div class="page-full">
                        <iframe src="https://verify.icheck.vn/n/add-on/log?domain=german.vn" width="100%" height="500px"
