    ...
    <div class="item_product_main">
      <form action="" method="post" class="variants product-action item-product-main duration-300" data-cart-form data-id="product-actions-34775949" enctype="multipart/form-data">
         ...
         <div class="product-thumbnail">
            <a class="image_thumb scale_hover" href="{{route('detailProduct',['cate'=>$pro->cate_slug,'type'=>$pro->type_slug ? $pro->type_slug : 'loai','id'=>$pro->slug])}}" title=" {{$pro->name}}">
            <img class=" duration-300" src="{{$img[0]}}"  alt=" {{$pro->name}}">
            </a>
         </div>
